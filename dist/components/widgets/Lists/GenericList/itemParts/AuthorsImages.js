...
function AuthorsImages({ context, widgetConfig, data }) {
    ...
    if (!authorsObjs || authorsObjs.length === 0) {
        return WidgetHelper_1.WidgetHelper.renderEmptyComponent('AuthorsImages');
    }
    return ((0, jsx_runtime_1.jsx)("div", { className: ['AuthorsImages'].join(' '), children: authorsObjs.map((author) => {
            ...
            return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: ((_a = author.image) === null || _a === void 0 ? void 0 : _a.url) &&
                    (0, jsx_runtime_1.jsx)("div", { className: "authorImage", children: (0, jsx_runtime_1.jsx)(RingImage_1.RingImage, { src: author.image.url, alt: author.image.caption || author.name, width: 100, height: 100, transform: RingImage_1.TransformType.ResizeCropAuto }) }) }));
        }) }));
}
