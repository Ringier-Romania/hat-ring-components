...
export async function TestSocialMedia_openGraphAndTwitterCards({page, playwrightTest, expectedValue} : {page: Page, playwrightTest: PlaywrightTest, expectedValue: {
    ...
    await playwrightTest.test.step('should have title og tag', async () => {
    ...
    await playwrightTest.test.step('should have description og tag', async () => {
    ...
    await playwrightTest.test.step('should have image og tag', async () => {
    ...
    await playwrightTest.test.step('should have url og tag', async () => {
    ...
    await playwrightTest.test.step('should have type og tag', async () => {
    ...
    await playwrightTest.test.step('should have site_name og tag', async () => {
    ...
    await playwrightTest.test.step('should have locale og tag', async () => {
    ...
    await playwrightTest.test.step('should have image:url og tag', async () => {
    ...
    await playwrightTest.test.step('should have image:secure_url og tag', async () => {
    ...
    await playwrightTest.test.step('should have image:type og tag', async () => {
    ...
    await playwrightTest.test.step('should have image:width og tag', async () => {
    ...
    await playwrightTest.test.step('should have image:height og tag', async () => {
    ...
    await playwrightTest.test.step('should have twitter card meta tag', async () => {
    ...
    await playwrightTest.test.step('should have twitter title meta tag', async () => {
    ...
    await playwrightTest.test.step('should have twitter description meta tag', async () => {
