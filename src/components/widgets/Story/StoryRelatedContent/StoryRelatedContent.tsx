...
export async function StoryRelatedContent({widgetConfig, context}: StoryRelatedContentParams) {
    ...
    return <div
        className={WidgetHelper_getWidgetCssClasses('StoryRelatedContent', widgetConfig, context, [cssModules])}>
