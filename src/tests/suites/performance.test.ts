...
export function PerformanceTest_imagesLoadingStrategy(playwrightTest: PlaywrightTest) {
...
export function PerformanceTest_visibleIframesLazyLoading(playwrightTest: PlaywrightTest) {
    const {test, expect} = playwrightTest;
