...
async function StoryMainImage({ widgetConfig, context }) {
    ...
    `;
    const imageDimensions = WidgetHelper_1.WidgetHelper.getImageDimensionsFromWidgetConfig(widgetConfig, context);
    const variables = {
        storyId: context.id,
        imageWidth: imageDimensions.width,
        imageHeight: imageDimensions.height,
    };
    var response = widgetConfig === null || widgetConfig === void 0 ? void 0 : widgetConfig.response;
    if (!response) {
