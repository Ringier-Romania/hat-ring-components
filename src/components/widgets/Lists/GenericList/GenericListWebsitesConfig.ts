    ...
    "modules": {
        "genericList_wdg": {
            ...
            "paramsDescription": {
                ...
                "headerText": {
                    "name": "Header text",
                    "description": "There are dynamic variables that can be used in the header text: {{totalItems}}, {{searchValue}}, {{dynamicName}}. Example: {{totalItems}} items for {{searchValue}}",
                    "type": "textfield"
                },
                "headerTag": {
                    "name": "Header tag",
