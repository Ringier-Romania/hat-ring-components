...
function ImageBlock({ blockData, config }) {
    ...
    return (0, jsx_runtime_1.jsxs)("div", { className: "ImageBlock", children: [link ?
                (0, jsx_runtime_1.jsx)(RingLink_1.RingLink, { href: link.url, children: (0, jsx_runtime_1.jsx)(RingImage_1.RingImage, { priority: true, src: url, alt: alt || '', width: config.width, height: config.height, transform: RingImage_1.TransformType.ResizeCropAuto }) }) :
                (0, jsx_runtime_1.jsx)(RingImage_1.RingImage, { priority: true, src: url, alt: alt || '', width: config.width, height: config.height, transform: RingImage_1.TransformType.ResizeCropAuto }), (0, jsx_runtime_1.jsxs)("div", { className: "imgMetaData", children: [title && (0, jsx_runtime_1.jsx)("span", { className: "caption", children: title }), image.description && (0, jsx_runtime_1.jsx)("span", { className: "description", children: image.description }), ((_a = image.sources) === null || _a === void 0 ? void 0 : _a.length) && (0, jsx_runtime_1.jsx)("span", { className: "copyright", children: `Foto: ${image.sources[0].source.name}` })] })] });
}
